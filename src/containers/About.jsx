  ...
  <>
    <div className="row my-5 py-5">
      ...
      <div className="col-lg-6">
        <h1>About</h1>
        <p>I am a full-stack software student. I have experience in: pair programming and real-world projects, experience with Ruby on Rails and JavaScript software. My career began in the education industry, so I am familiar with leading people, learning and teaching new concepts, and keeping up to date with recent information. I am currently completing coursework at Microverse, a remote pair-programming school, building several front-end and back-end projects.

          - In my free time, I enjoy playing music, singing and cooking, but I hate watching horror movies.
